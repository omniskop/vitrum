...
func TestLex(t *testing.T) {
	tests := []struct {
		...
		output: []interface{}{token{tokenIdentifier, "event", vit.PositionRange{"", 1, 1, 1, 5}}, token{tokenIdentifier, "onClicked", vit.PositionRange{"", 1, 7, 1, 15}}, token{tokenLeftParenthesis, "", vit.PositionRange{"", 1, 16, 1, 16}}, token{tokenIdentifier, "MouseEvent", vit.PositionRange{"", 1, 17, 1, 26}}, token{tokenIdentifier, "event", vit.PositionRange{"", 1, 28, 1, 32}}, token{tokenRightParenthesis, "", vit.PositionRange{"", 1, 33, 1, 33}}},
	}, {
